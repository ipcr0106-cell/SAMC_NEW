  ...
  return (
    <AppLayout>
      <div className="max-w-4xl">
        {/* 헤더 */}
        <div className="mb-6">
          <h1 className="text-xl font-bold text-slate-900">법령 DB 관리</h1>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-lg border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-navy-600 placeholder-slate-400"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                type="date"
                className="w-full px-3 py-2 rounded-lg border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-navy-600"
              />
            </div>
            <div>
              <label className="block text-xs font-medium text-slate-600 mb-1">법령 등급 <span className="text-red-500">*</span></label>
              <select className="w-full px-3 py-2 rounded-lg border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-navy-600 text-slate-700">
                <option value="1">1 — 법률</option>
                <option value="2">2 — 시행령</option>
                <option value="3">3 — 시행규칙</option>
                <option value="4" selected>4 — 고시</option>
              </select>
            </div>
          ...
          {/* 파일 드롭존 */}
          <div className="border-2 border-dashed border-slate-200 rounded-xl p-8 text-center hover:border-navy-400 hover:bg-slate-50 transition-colors cursor-pointer mb-4">
          ...
          <div className="flex justify-end">
            <button className="text-sm bg-navy-700 text-white font-medium px-6 py-2.5 rounded-lg hover:bg-navy-800 transition-colors flex items-center gap-2">
